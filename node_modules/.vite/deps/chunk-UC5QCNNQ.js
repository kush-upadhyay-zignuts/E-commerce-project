...
var List = React8.forwardRef(function List2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiList"
  });
  ...
  return (0, import_jsx_runtime6.jsx)(ListContext_default.Provider, {
    value: context,
    children: (0, import_jsx_runtime6.jsxs)(ListRoot, {
      as: component,
      className: clsx_default(classes.root, className),
      ref,
      ownerState,
...
var MenuList = React9.forwardRef(function MenuList2(props, ref) {
  ...
  return (0, import_jsx_runtime7.jsx)(List_default, {
    role: "menu",
    ref: handleRef,
    className,
...
//# sourceMappingURL=chunk-UC5QCNNQ.js.map
